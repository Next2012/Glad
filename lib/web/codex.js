        ...
        function renderCodexSubagentGroup(threadId, items, permissionById, usedPermissions, interactive = true) {
        ...
        function buildCodexConversationHtml(messages = codexMessages, permissions = codexPendingPermissions, state = codexState) {
            const parts = [];
            ...
            for (let i = 0; i < visible.length;) {
                ...
                if (isCodexSubagentItem(item, state.threadId)) {
                    ...
                    if (!renderedSubagents.has(threadId)) {
                        ...
                        parts.push(renderCodexSubagentGroup(threadId, subagentItems.get(threadId) || [], permissionById, usedPermissions, messages === codexMessages));
                    }
                    i += 1;
                    continue;
                }
