        ...
        function codexReadyForInput() {
            return codexState.status === 'idle'
                && !codexState.aborting && !codexState.resuming && !codexResumeInFlight && !codexForkInFlight;
        }
        ...
        function renderCodexStateBar() {
            ...
            else if (codexForkInFlight) parts.push('<span class="claude-state-pill">Forking conversation…</span>');
