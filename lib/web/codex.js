        ...
        function renderCodexSubagentGroup(threadId, items, permissionById, usedPermissions, interactive = true, markdownOptions = {}) {
            ...
            for (let i = 0; i < visible.length;) {
                ...
                if (isCodexSubagentItem(item, state.threadId)) {
                    ...
                    if (!renderedSubagents.has(threadId)) {
                        ...
                        parts.push(renderCodexSubagentGroup(threadId, subagentItems.get(threadId) || [], permissionById, usedPermissions, messages === codexMessages, markdownOptions));
                    }
                    i += 1;
                    continue;
                }
