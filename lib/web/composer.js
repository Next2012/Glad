        ...
        function syncComposerButtonState() {
            ...
            document.getElementById('attach-file-btn').classList.toggle('active', selectedFileAttachments.length > 0);
        }
        ...
        function performSend() {
            ...
            if ((val || readyImageAttachments.length || readyFileAttachments.length) && isCodexSession() && codexState.presentation === 'structured') {
